...
- 적 의도는 완전 공개인가, 일부 공개인가
- 파티원 사망은 전투 중 일시 손실인가, 런 전체 손실인가
- 최대 파티원 수는 3명으로 고정할 것인가, 더 확장할 것인가
- 파티원별 드로우 장수와 손패 최대치를 어떻게 둘 것인가
- 비선택 파티원의 손패 정보를 UI에서 어느 정도 보여줄 것인가
- 특수 카드는 전투 중 임시 생성인지, 덱에 편입되는 카드인지
